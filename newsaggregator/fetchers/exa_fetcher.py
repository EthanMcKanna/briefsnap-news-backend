        ...
        try:
            ...
            if not article_contents:
                ...
                try:
                    ...
                    print(f"[INFO] Successfully generated summary for: {story_title}")
                except Exception as e:
                    print(f"[ERROR] Failed to generate summary after all retries for '{story_title}': {e}")

                try:
                    key_points = self._generate_key_points(article_text)
                    print(f"[INFO] Successfully generated key points for: {story_title}")
                except Exception as e:
                    print(f"[ERROR] Failed to generate key points after all retries for '{story_title}': {e}")
